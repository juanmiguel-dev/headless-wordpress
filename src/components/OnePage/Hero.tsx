            ...
            <ParallaxSection speed={0.2}>
                <div className="relative z-10 max-w-5xl px-4">
                    ...
                    <p className="mx-auto max-w-2xl text-gray-400 text-lg md:text-xl leading-relaxed font-light mt-12">
                        Deconstructing the boundaries of digital expression. Crafting unique
                        visual narratives with <span className="text-white font-medium">Digital Tools</span> + <span className="text-white font-medium">Creative Passion</span>.
                    </p>

            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 border-l border-t border-white/10">
                    {stack.map((item, index) => (
                        <div
                            key={index}
                            className="group p-10 border-r border-b border-white/10 bg-white/[0.01] hover:bg-white/[0.03] transition-all duration-500 relative overflow-hidden"
                        >
                            {/* Hover Highlight */}
                            <div className="absolute top-0 left-0 w-full h-[2px] bg-neon-lime scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
